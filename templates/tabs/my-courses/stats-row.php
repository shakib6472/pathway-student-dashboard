 ...
 * Each card carries a tinted icon circle.
 *
...
<div class="pd-stats">
	...
	<div class="pd-stats__card">
		<span class="pd-stats__icon"><?php echo pathway_dash_icon( 'chart' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- static SVG. ?></span>
		<div class="pd-stats__body">
	...
	<div class="pd-stats__card">
		<span class="pd-stats__icon"><?php echo pathway_dash_icon( 'book' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- static SVG. ?></span>
		<div class="pd-stats__body">
	...
	<div class="pd-stats__card">
		<span class="pd-stats__icon"><?php echo pathway_dash_icon( 'award' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- static SVG. ?></span>
		<div class="pd-stats__body">
	...
	<div class="pd-stats__card">
		<span class="pd-stats__icon"><?php echo pathway_dash_icon( 'clock' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- static SVG. ?></span>
		<div class="pd-stats__body">
